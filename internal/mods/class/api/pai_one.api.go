...
// @Router /api/v1/class/pai-ones [get]
func (a *PaiOne) Query(c *gin.Context) {
	...
	var list []*schema.PaiOne
	a.PaiOneBIZ.Trans.DB.Find(&list)
	if len(list) == 0 {
		var userList []*schema.Employ
		a.PaiOneBIZ.Trans.DB.Find(&userList)
		for _, item := range userList {
			if !item.IsTeacher {
				...
				row.Score = 0
				a.PaiOneBIZ.Trans.DB.Create(&row)
			}
		}
	}
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/class/pai-ones/{id} [get]
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/class/pai-ones [post]
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/class/pai-ones/{id} [put]
...
// @Failure 401 {object} util.ResponseResult
// @Failure 500 {object} util.ResponseResult
// @Router /api/v1/class/pai-ones/{id} [delete]
